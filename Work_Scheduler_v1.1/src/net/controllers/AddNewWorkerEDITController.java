...
public class AddNewWorkerEDITController implements Initializable {
    ...
    public void handleSave() throws IOException {
        if(firstName.getText().equals("") || lastName.getText().equals("")){
            ...
            if (checkSelectedShifts() && isAnyDaySelected()) {
                ...
                EditScheduleController.getSchedule().getWorkers().add(new Worker(firstName.getText(), lastName.getText(),
