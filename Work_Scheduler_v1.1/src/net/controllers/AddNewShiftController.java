...
public class AddNewShiftController implements Initializable {
    ...
    public void handleSave() throws IOException {
        if (shiftName.getText().isEmpty() || startTimeHComboBox.getSelectionModel().isEmpty() || startTimeMComboBox.getSelectionModel().isEmpty()
            ...
            if(!NewScheduleController.getTemp().getShifts().isEmpty()) {
            ...
            if(exists == false) {
                ...
                NewScheduleController.getTemp().getShifts().add(shift);
